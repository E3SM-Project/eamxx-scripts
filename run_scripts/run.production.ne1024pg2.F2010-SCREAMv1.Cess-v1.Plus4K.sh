...
readonly CASE_NAME=cess-v1-plus4K.${RESOLUTION}.${COMPSET}.${CHECKOUT}
...
EOF
    ...
    ./xmlchange --file env_run.xml --id SSTICE_DATA_FILENAME --val "/lustre/orion/cli115/world-shared/e3sm/inputdata/atm/cam/sst/sst_ostia_ukmo-l4_ghrsst_3600x7200_20190731_20200901_plus4K_c20230707.nc"
