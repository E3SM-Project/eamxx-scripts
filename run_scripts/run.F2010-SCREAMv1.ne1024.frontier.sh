...
readonly CASE_NAME=t.${CHECKOUT}.${COMPSET}.${RESOLUTION}.${MACHINE}.n2048t8x6.vth200.oc
...
if [ "${MACHINE}" == "quartz" ]; then
    ...
    readonly CODE_ROOT="/global/cfs/cdirs/e3sm/ndk/repos/${CHECKOUT}"
    readonly CASE_ROOT="/pscratch/sd/n/${USER}/e3sm_scratch/${MACHINE}/${CHECKOUT}/${CASE_NAME}"
    readonly PROJECT="e3sm"

elif [ "${MACHINE}" == "summit" ]; then

    readonly CODE_ROOT="/gpfs/alpine/cli115/proj-shared/noel/wacmy/${CHECKOUT}"
    readonly CASE_ROOT="/gpfs/alpine/cli115/proj-shared/noel/e3sm_scratch/${CHECKOUT}/${CASE_NAME}"
    readonly PROJECT="cli115"

elif [ "${MACHINE}" == "frontier-scream-gpu" ]; then

    readonly CODE_ROOT="/lustre/orion/cli115/proj-shared/noel/wacmy/${CHECKOUT}"
    readonly CASE_ROOT="/lustre/orion/cli115/proj-shared/noel/e3sm_scratch/${CHECKOUT}/${CASE_NAME}"
    readonly PROJECT="cli115"
...
runtime_options() {
    ...
    # Use new SST file
    ./xmlchange --file env_run.xml --id SSTICE_DATA_FILENAME --val /lustre/orion/cli115/proj-shared/terai/sst_ostia_ukmo-l4_ghrsst_3600x7200_20190731_20200901_c20230522.nc
    ./xmlchange --file env_run.xml --id  SSTICE_GRID_FILENAME --val /lustre/orion/cli115/proj-shared/terai/domain.ocn.3600x7200.230522.nc
    ...
    # Set vtheta threshold to 200K
    ./atmchange vtheta_thresh=200
    ./atmquery vtheta_thresh

    ./atmchange initial_conditions::Filename="/lustre/orion/cli115/world-shared/e3sm/inputdata/atm/scream/init/screami_ne1024np4L128_era5-20160801-topoadjx6t_20221006.nc"
