...
runtime_options() {
    ...
    ./atmchange initial_conditions::Filename="/lustre/orion/cli115/proj-shared/hannah6/HICCUP/data/HICCUP-IC.atm_era5.2020-01-20.ne256np4.L128.converted.nc"
...
EOF
    ...
    cp ${SCREAMDOCS_ROOT}"/scream_output.AutoCal.ne256pg2.3hourly_avg_remap_to_ne120pg2.yaml" .
    cp ${SCREAMDOCS_ROOT}"/scream_output.AutoCal.ne256pg2.daily_avg_remap_to_ne30pg2.yaml" .
    cp ${SCREAMDOCS_ROOT}"/scream_output.AutoCal.ne256pg2.daily_max.yaml" .
    cp ${SCREAMDOCS_ROOT}"/scream_output.AutoCal.ne256pg2.daily_min.yaml" .
    cp ${SCREAMDOCS_ROOT}"/scream_output.AutoCal.ne256pg2.hourly_inst.yaml" .
    cp ${SCREAMDOCS_ROOT}"/scream_output.AutoCal.ne256pg2.hourly_inst_remap_to_ne30pg2.yaml" .
    cp ${SCREAMDOCS_ROOT}"/scream_output.AutoCal.ne256pg2.daily_avg_cosp_remap_to_ne30pg2.yaml" .

    ./atmchange output_yaml_files="./scream_output.AutoCal.ne256pg2.3hourly_avg_remap_to_ne120pg2.yaml"
    ./atmchange output_yaml_files+="./scream_output.AutoCal.ne256pg2.daily_avg_remap_to_ne30pg2.yaml"
    ./atmchange output_yaml_files+="./scream_output.AutoCal.ne256pg2.daily_max.yaml"
    ./atmchange output_yaml_files+="./scream_output.AutoCal.ne256pg2.daily_min.yaml"
