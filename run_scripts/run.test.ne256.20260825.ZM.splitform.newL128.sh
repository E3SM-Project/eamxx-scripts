...
readonly TUNINGSET="splitform_TMSoff_JanStart_outputoff"
...
runtime_options() {
    ...
    ./atmchange physics::atm_procs_list="'zm','mac_aero_mic','rrtmgp'"
    ./atmchange -b zm::use_fortran_bridge=false
    ...
    ./atmchange -b vertical_coordinate_filename="/global/cfs/cdirs/e3sm/inputdata/atm/scream/init/vertical_coordinates_L128v4_c20260820.nc"
    ./atmchange -b initial_conditions::filename="/global/cfs/cdirs/e3sm/inputdata/atm/scream/init/screami_ne256np4L128v4_ifs-20200120_20260825.nc"
...
cat << EOF >> user_nl_elm
  finidat='/global/cfs/cdirs/e3sm/inputdata/lnd/clm2/initdata/20240305.I2010CRUELM.ne256pg2.elm.r.2020-01-20-00000.nc'
