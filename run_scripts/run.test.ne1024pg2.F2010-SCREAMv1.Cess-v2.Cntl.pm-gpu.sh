...
readonly BRANCH="eamxx-v0.1.0"  #master for current master
readonly CHERRY=( )
...
readonly CODE_ROOT="/pscratch/sd/t/terai/E3SM_code/eamxx-v0.1.0" #To change
readonly PROJECT="e3sm"                                          #To change
...
readonly PELAYOUT="2048x1" # 512 nodes
readonly WALLTIME="02:50:00"
...
runtime_options() {
    ...
    # Set atmos IC file
    ./atmchange initial_conditions::filename="/global/cfs/cdirs/e3sm/inputdata/atm/scream/init/screami_ne1024np4L128_era5-20190801-topoadjx6t_20230620.nc"
...
cat << EOF >> user_nl_elm
 finidat='/global/cfs/cdirs/e3sm/inputdata/lnd/clm2/initdata/20220928.I2010CRUELM.ne1024pg2_ICOS10.elm.r.2016-08-01-00000.nc'
...
cat << EOF >> scream_output.Cess.monthly.yaml
%YAML 1.1
---
filename_prefix: output.scream.Cess.monthly
...
cat << EOF >> scream_output.Cess.3hourly.yaml
%YAML 1.1
---
filename_prefix: output.scream.Cess.3hourlyINST
...
cat << EOF >> scream_output.Cess.hourly.yaml
%YAML 1.1
---
filename_prefix: output.scream.Cess.hourly
averaging_type: Instant
...
EOF
    ...
    # Add scream outputs
    ./atmchange output_yaml_files="scream_output.Cess.monthly.yaml"
    ./atmchange output_yaml_files+="scream_output.Cess.3hourly.yaml"
    ./atmchange output_yaml_files+="scream_output.Cess.hourly.yaml"
