...
# Description:
#
# Submission script used for a 10-day ne1024pg2
# simulation using dt=50s rather than the default
# dt=100s.
#
# The purpose of this run is to investigate the
# cold T bias we see in our runs at a lower
# timestep.
#==============================================#
...
./xmlchange JOB_WALLCLOCK_TIME=7:00:00
./xmlchange STOP_OPTION=ndays
./xmlchange STOP_N=10
./xmlchange HIST_N=99999; ./xmlchange HIST_OPTION=nyears ;
./xmlchange REST_N=10; ./xmlchange REST_OPTION=ndays ;
...
./xmlchange ATM_NCPL=1728  # Switch atm dt to 50s
...
./atmchange rad_frequency=6  # Make sure rrtmgp still supersteps every 300s
