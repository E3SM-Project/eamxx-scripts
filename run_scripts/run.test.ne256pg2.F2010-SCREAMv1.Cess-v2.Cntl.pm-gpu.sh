...
readonly PELAYOUT="512x1" # 128 nodes
...
runtime_options() {
    ...
    # Set atmos IC file
    ./atmchange initial_conditions::filename="/global/cfs/cdirs/e3sm/inputdata/atm/scream/init/screami_ne256np4L128_era5-20190801-topoadjx6t_20230620.nc"
...
cat << EOF >> user_nl_elm
 finidat='/global/cfs/cdirs/e3sm/inputdata/lnd/clm2/initdata/20230522.I2010CRUELM.ne256pg2.elm.r.2013-08-01-00000.nc'
