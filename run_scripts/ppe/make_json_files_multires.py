...
PARAMETERS = [
    ...
    Parameter("length_fac", 0.1, 10.0, "linear"),
    Parameter("c_diag_3rd_mom", 0.01, 10.0, "log"),
    Parameter("coeff_kh", 0.01, 1.0, "log"),
    Parameter("coeff_km", 0.01, 1.0, "log"),
    ...
    Parameter("max_total_ni", 5.0e5, 1.0e7, "log"),
    Parameter("ice_sedimentation_factor", 0.1, 2.0, "linear"),
