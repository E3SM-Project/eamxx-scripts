...
readonly RESOLUTION="ne128pg2_ne128pg2"
...
runtime_options() {
    ...
    ./xmlchange ATM_NCPL=96 # dtime=15min for ne128
...
horiz_remap_file: /global/cfs/cdirs/e3sm/beydoun/autotune_utils/map_ne128pg2_to_ne32pg2.nc
iotype: pnetcdf
output_control:
  frequency: 1
