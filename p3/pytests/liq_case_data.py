...
a configuration where liquid but not ice processes are exercised. Note
that a negligible amount of ice was created when this case was run on
8/14/18, so more work may be needed.
"""
