#ifndef MICRO_SED_PACKNOI_KOKKOS_HPP
#define MICRO_SED_PACKNOI_KOKKOS_HPP
...
struct MicroSedFuncPackNoiKokkos : public MicroSedFuncPackKokkos<Real> {

  static constexpr const char* NAME = "kokkos_packnoi";

public:
  MicroSedFuncPackNoiKokkos(int num_horz_, int num_vert_) :
    MicroSedFuncPackKokkos<Real>(num_horz_, num_vert_)
  {  }
};
...
void micro_sed_func (
  MicroSedFuncPackNoiKokkos<Real>& m,
