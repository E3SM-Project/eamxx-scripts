...
set job_name       = E3SMv1_PresAeroFinal_201102
set compset        = F2010C5-CMIP6-LR
set resolution     = ne30_oEC
set machine        = cori-knl
set walltime       = 12:29:00
setenv project       e3sm

### SOURCE CODE OPTIONS
set fetch_code     = false
set acme_tag       = master
set tag_name       = maint-1.0/E3SM
set case_tag_name  = maint-1.0
### CUSTOM CASE_NAME
set case_name = ${case_tag_name}.${compset}.${job_name}.${resolution}
...
set seconds_before_delete_source_dir = 3
...
set acme_simulations_dir        = ~/E3SM/cases/
set case_build_dir              = /global/cscratch1/sd/terai/E3SM_simulation/${case_name}/bld
set case_run_dir                = /global/cscratch1/sd/terai/E3SM_simulation/${case_name}/run
set short_term_archive_root_dir = $CSCRATCH/E3SM_simulation/${case_name}/archive
...
set records_per_atm_output_file  = 24
...
cat <<EOF >> user_nl_cam
 ...
 get_presc_aero_data=.true.  

EOF

cat <<EOF >> user_nl_clm
 !finidat='/global/cfs/cdirs/e3sm/inputdata/lnd/clm2/initdata_map/20180716.DECKv1b_A3.ne30_oEC.edison.clm2.r.2010-01-01-00000_to_r0125.20200213.nc'
